...
The models in table \ref{tab:architecture} using a Transformer as an encoder required $\sim 3$\ GPU days, while the models using an RNN encoder needed $\sim 6$\ GPU days.
