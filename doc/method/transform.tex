...
A possible interpretation of the fact that our comvined predictiors of RNNs and Transformers indicate better performance for predictors with Transformers as decoders could be that the Transformer architecture is better in utilizing the meta data, i.e. the collision energy and charge state state information. A future direction of the project could be to investigate the source of the improved accuracy by removing this information to the decoders. 
